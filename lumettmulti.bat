...
start /b .\bin\mintty.exe -p centre -p bottom --o PgUpDnScroll=no --o Hold=error --Report o --horbar=3 --configdir '.\usr\share\mintty' -c '.\.mintty\mintty_wcli'_rc -i './lumett.ico' -e '.\bin\tt++.exe' -t 'LumeTT Client' -r './lib/init.tin' -e 'launch commander'
...
start /b .\bin\mintty.exe -p top --o Hold=error --Report o --configdir '.\usr\share\mintty' --class 'one' --tabbar -c './.mintty/mintty_wcom_rc' -i './lumett.ico' -e './bin/tt++.exe' -G -t 'chats' -r './lib/gui/win_comms_all.tin' %*
start /b .\bin\mintty.exe -p top --o Hold=error --Report o --configdir '.\usr\share\mintty' --class 'one' --tabbar -c './.mintty/mintty_wcom_rc' -i './lumett.ico' -e './bin/tt++.exe' -G -t 'guild' -r './lib/gui/win_comms_guild.tin' %*
start /b .\bin\mintty.exe -p top --o Hold=error --Report o --configdir '.\usr\share\mintty' --class 'one' --tabbar -c './.mintty/mintty_wcom_rc' -i './lumett.ico' -e './bin/tt++.exe' -G -t 'group' -r './lib/gui/win_comms_grp.tin' %*

REM start the side tabbed window

start /b .\bin\mintty.exe -p left --o Hold=error --Report o --configdir '.\usr\share\mintty' --class 'two' --tabbar -c './.mintty/mintty_wside_rc' -i './lumett.ico' -e './bin/tt++.exe' -G -t 'Alias' -r './lib/gui/win_side_alias.tin' %*
start /b .\bin\mintty.exe -p left --o Hold=error --Report o --configdir '.\usr\share\mintty' --class 'two' --tabbar -c './.mintty/mintty_wside_rc' -i './lumett.ico' -e './bin/tt++.exe' -G -t 'Equip' -r './lib/gui/win_side_eq.tin' %*
